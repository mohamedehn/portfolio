...
import bookiImg from '../public/assets/projects/bookiBackground.webp';
  ...
  return (
    <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
            ...
            <Image className='absolute z-1' layout='fill' objectFit='cover' alt='' src={bookiImg}/>
        ...
        <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
            <div className='col-span-4'>
                ...
                <a href="https://mohamedehn.github.io/openclassrooms.booki/"><button className='px-8 py-2 mt-4 mr-8'>Démo</button></a> 
                <a href="https://github.com/mohamedehn/openclassrooms.booki/tree/dev"><button className='px-8 py-2 mt-4'>Code</button></a>
            </div>
