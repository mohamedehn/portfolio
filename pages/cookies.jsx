        ...
        <div className="relative md:bg-[#ecf0f3] md:p-6 mx-auto max-w-7xl px-6 lg:px-8">
              <div className="lg:grid lg:grid-cols-1 lg:gap-6">
                <div className="rounded-md shadow w-[25%] justify-center flex mx-auto mt-10">
                    <Link href="/" className="flex w-full items-center justify-center rounded-md border border-transparent px-8 py-3 
                 ...
                 lg:mx-0 text-justify pt-0">
                    ...
                    <div>
                        ...
                        <p className='pb-10 leading-8'>
                            Les cookies déposés par Coding Corp, nos sous-traitants et nos partenaires et les données de 
                    ...
                    <div>
                        ...
                        <p className='leading-8'>
                            Coding Corp se réserve le droit de modifier ou de mettre à jour cette politique lorsque cela 
