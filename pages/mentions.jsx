    ...
    <div className='bg-[#ecf0f3] h-full text-justify'>
        <div className="relative md:bg-[#ecf0f3] md:p-6 mx-auto max-w-7xl px-6 lg:px-8">
              <div className="lg:grid lg:grid-cols-1 lg:gap-6">
                <div className="prose prose-lg prose-indigo text-gray-600 lg:max-w-none sm:mx-auto sm:mt-5 sm:max-w-xl md:mt-5 
                 lg:mx-0 text-justify pt-14">
                  ...
                  <div>
                    ...
                    <p className='leading-8'>
                        ...
                        Siège social : 7 Impasse de la Boutas 38090 VILLEFONTAINE - Tél : 06 87 41 O9 41 <br/>
                        Email: contact@codingcorp.fr <br/>
                        Entreprise individuelle créée en 2023 – Code 62.01Z - SIRET : 953 263 423 00014<br/>
                  ...
                  <div>
                    ...
                    <p className='leading-8'>
                        Les internautes accédant au site https://mohamedehn.github.io/portfolio peuvent être amenés à fournir des informations nominatives ou 
                        à caractère personnel dans le cadre des services proposés par Coding Corp.
                    </p>
                    <p className='leading-8'>
                        L’entreprise Coding Corp est responsable de traitement au sens du Règlement (UE) 2016/679 dit Règlement Général pour 
                        la Protection des Données ou « RGPD », pour la collecte et le traitement des données à caractère personnel effectuées 
                        sur le site accessible à l’adresse URL: <br/> https://mohamedehn.github.io/portfolio
                    </p>
                    <p className='pt-3'>L’entreprise Coding Corp traite les données personnelles collectées via son site pour les finalités suivantes :</p>
                    <p className='leading-8'>
                    ...
                    <p className='pt-3 text-justify leading-8'>
                        Si le visiteur estime que Coding Corp n’a pas correctement répondu à ses sollicitations, il dispose d’un 
                        droit d’introduire une réclamation auprès de la CNIL. Coding Corp limite la collecte des données 
                        personnelles au strict nécessaire au regard des finalités des traitements de données, elles sont destinées à 
                        l&apos;entrprise Coding Corp mais sont susceptibles d’être transférées à des organismes publics afin de mieux répondre 
                    ...
                    <p className='leading-8'>
                        Coding Corp veille à ce que toutes les mesures techniques et organisationnelles afin de protéger les 
                        données personnelles soient mises en œuvre, ces règles de confidentialités et de sécurité sont également imposées à 
                        l’ensemble du personnel de Coding Corp , ainsi qu’à tous les prestataires et sous-traitants travaillant 
                        pour Coding Corp.
                    </p>
                  </div>
                </div>
