...
function ProjectItem({title, backgroundImg, url, tech}) {
  return (
    <div className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl p-4 group hover:bg-gradient-to-r from-[#338be9] to-[#82a7ff]">
